...
import util.{PipeStage, PipeData, SignExtend, SignExtendU}
...
class PopulateByForm extends PipeStage(new DecoderData, new ReadInterface){
  ...
  switch(i.form) {
    ...
    is(FormEnums.B1){
      ...
      when(bo(2) === False){
        o.slots(ReadSlotPacking.SPRPort1).idx := SPREnums.CTR
    ...
    is(FormEnums.D1){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.D1.RA(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.SPRPort1).idx := SPREnums.XER
      o.slots(ReadSlotPacking.SPRPort1).sel := SourceSelect.SPR
      ...
      when(bf(0) === False) {
        o.write_interface.slots(WriteSlotPacking.CRPort1).idx := mask
        o.write_interface.slots(WriteSlotPacking.CRPort1).sel := SourceSelect.CRA
      }.otherwise {
        o.write_interface.slots(WriteSlotPacking.CRPort2).idx := mask
        o.write_interface.slots(WriteSlotPacking.CRPort2).sel := SourceSelect.CRB
      }
      o.imm.valid := True
      o.imm.bits := SignExtendU(Forms.D1.SI(i.insn), 64)
    }

    is(FormEnums.D2){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.D2.RA(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.SPRPort1).idx := SPREnums.XER
      o.slots(ReadSlotPacking.SPRPort1).sel := SourceSelect.SPR
      val bf = Forms.D1.BF(i.insn)
      ...
      o.imm.valid := True
      o.imm.bits := Forms.D2.UI(i.insn)
    }

    is(FormEnums.D5){
      val ra = Forms.D5.RA(i.insn)
      when( ra =/= 0) {
        o.slots(ReadSlotPacking.GPRPort1).idx := Forms.D5.RA(i.insn)
        o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      }
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.D5.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := SignExtendU(Forms.D5.D(i.insn), 64)
    ...
    is(FormEnums.D6){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.D6.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.D6.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := Forms.D6.UI(i.insn)
    ...
    is(FormEnums.D7){
      ...
      when(ra =/= 0){
        o.slots(ReadSlotPacking.GPRPort1).idx := ra
        o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      }
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.D7.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := SignExtendU(Forms.D7.D(i.insn), 64)
    ...
    is(FormEnums.D8){
      ...
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := rt
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := SignExtendU(Forms.D8.SI(i.insn), 64)
    ...
    is(FormEnums.DS5){
      ...
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.DS5.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := SignExtendU(Forms.DS5.DS(i.insn), 64)
    ...
    is(FormEnums.I1){
      ...
      when(Forms.I1.LK(i.insn) === True){
        o.write_interface.slots(WriteSlotPacking.SPRPort1).idx := SPREnums.LR
        o.write_interface.slots(WriteSlotPacking.SPRPort1).sel := SourceSelect.SPR
      }
    }

    is(FormEnums.M2){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.M2.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      when(i.opcode === MnemonicEnums.rlwimi_dot_){
        o.slots(ReadSlotPacking.GPRPort3).idx := Forms.M2.RA(i.insn)
        o.slots(ReadSlotPacking.GPRPort3).sel := SourceSelect.GPR
      }
      o.imm.valid := True
      o.imm.bits := Forms.M2.SH(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.M2.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.MD1){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.MD1.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := Cat(Forms.MD1.sh2(i.insn), Forms.MD1.sh1(i.insn)).asUInt
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.MD1.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.MD2){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.MD2.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := Cat(Forms.MD2.sh2(i.insn), Forms.MD2.sh1(i.insn)).asUInt
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.MD2.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.MDS2){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.MDS2.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.MDS2.RB(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.MDS2.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.X30){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.X30.RA(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.X30.RB(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.SPRPort1).idx := SPREnums.XER
      o.slots(ReadSlotPacking.SPRPort1).sel := SourceSelect.SPR
    ...
    is(FormEnums.X62){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.X62.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.X62.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.X65){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.X65.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := Forms.X65.SH(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.X65.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.SPRPort1).idx := SPREnums.XER
      o.write_interface.slots(WriteSlotPacking.SPRPort1).sel := SourceSelect.SPR
      when(Forms.X62.Rc(i.insn) === True){
        o.write_interface.slots(WriteSlotPacking.CRPort1).idx := 8
        o.write_interface.slots(WriteSlotPacking.CRPort1).sel := SourceSelect.CRA
    ...
    is(FormEnums.X66){
      ...
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.X66.RB(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.GPRPort3).idx := Forms.X66.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort3).sel := SourceSelect.GPR
    }

    is(FormEnums.X68){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.X68.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.X68.RB(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.X68.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.X77){
      ...
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.X77.RB(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR

      o.write_interface.slots(ReadSlotPacking.GPRPort1).idx := Forms.X77.RT(i.insn)
      o.write_interface.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.write_interface.slots(ReadSlotPacking.GPRPort2).idx := Forms.X77.RA(i.insn)
      o.write_interface.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
    }

    is(FormEnums.XFX2, FormEnums.XFX3){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.XFX2.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      ...
      when(maska =/= 0){
        o.write_interface.slots(WriteSlotPacking.CRPort1).idx := maska.asUInt
        o.write_interface.slots(WriteSlotPacking.CRPort1).sel := SourceSelect.CRA
      }
      when(maskb =/= 0){
        o.write_interface.slots(WriteSlotPacking.CRPort2).idx := maskb.asUInt
        o.write_interface.slots(WriteSlotPacking.CRPort2).sel := SourceSelect.CRB
      }
    }
    is(FormEnums.XFX4){
      ...
      o.slots(ReadSlotPacking.GPRPort1).idx := rs
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.SPRPort1).idx := spr
      o.write_interface.slots(WriteSlotPacking.SPRPort1).sel := SourceSelect.SPR
    }
    ...
    is(FormEnums.XFX5){
      ...
      o.slots(ReadSlotPacking.CRPort2).idx := 0xf
      o.slots(ReadSlotPacking.CRPort2).sel := SourceSelect.CRB
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.XFX5.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    }
    is(FormEnums.XFX6){
      ...
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.XFX6.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    }
    ...
    is(FormEnums.XFX8){
      ...
      o.slots(ReadSlotPacking.SPRPort1).sel := SourceSelect.SPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.XFX8.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    }
    ...
    is(FormEnums.XL4){
      when(i.opcode === MnemonicEnums.bclr_l_){
        o.slots(ReadSlotPacking.SPRPort1).idx := SPREnums.LR
        o.slots(ReadSlotPacking.SPRPort1).sel := SourceSelect.SPR
      }
    ...
    is(FormEnums.XO1){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.XO1.RA(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.XO1.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.XO3){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.XO3.RA(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.XO3.RB(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.XO3.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.XO4){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.XO4.RA(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.slots(ReadSlotPacking.GPRPort2).idx := Forms.XO4.RB(i.insn)
      o.slots(ReadSlotPacking.GPRPort2).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.XO4.RT(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
    ...
    is(FormEnums.XS1){
      o.slots(ReadSlotPacking.GPRPort1).idx := Forms.XS1.RS(i.insn)
      o.slots(ReadSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.imm.valid := True
      o.imm.bits := Cat(Forms.XS1.sh2(i.insn), Forms.XS1.sh1(i.insn)).asUInt
      o.write_interface.slots(WriteSlotPacking.GPRPort1).idx := Forms.XS1.RA(i.insn)
      o.write_interface.slots(WriteSlotPacking.GPRPort1).sel := SourceSelect.GPR
      o.write_interface.slots(WriteSlotPacking.SPRPort1).idx := SPREnums.XER
      o.write_interface.slots(WriteSlotPacking.SPRPort1).sel := SourceSelect.SPR
